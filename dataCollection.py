...
confidence = 0.8
save = True
blurThreshold = 40  # Larger is more focus
debug = False
...
# Specify camera index as 0 for front-facing camera
...
while True:
    ...
    if bboxs:
        ...
        # ------  Create a copy of the image with drawing --------
        imgWithDrawing = imgOut.copy()
        ...
        if save:
            ...
            if all(listBlur) and listBlur != []:
                ...
                # ------  Save the image with the drawing  ------
                #cv2.imwrite(f"{outputFolderPath}/{timeNow}_with_drawing.jpg", imgWithDrawing)
